  ...
  <div class="ag-card p-4 chart-container hover-lift">
    <div class="ag-flex-between mb-4">
      ...
      <div class="ag-icon-box bg-card border">
        <ion-icon :icon="statsChartOutline" class="text-muted" />
      </div>
    </div>

    <div v-if="loading" class="chart-area ag-flex-center">
      <ion-skeleton-text animated class="skeleton-chart"></ion-skeleton-text>
    </div>
...
import {
  ...
  LinearScale, PointElement, CategoryScale, Filler, ScriptableContext
} from 'chart.js';
...
.skeleton-chart { width: 100%; height: 100%; border-radius: 8px; }
