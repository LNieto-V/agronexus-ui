  ...
  <div class="chat-shell">
    ...
    <div class="chat-main">
      ...
      <div class="chat-toolbar">
        ...
        <button class="new-btn hide-on-mobile" style="margin-right:0.5rem" @click="reportModalOpen = true">
          <FileText :size="16" />
          <span>Informe</span>
        </button>
        ...
        <div class="chat-container">
          ...
          <div v-for="msg in messages" :key="msg.id" class="message-wrapper" :class="msg.role" :id="`msg-${msg.id}`">
            ...
            <div class="message-meta">
              ...
              <ExportPdfButton v-if="msg.role === 'ai'" :element-id="`msg-${msg.id}`" class="dl-btn" />
            </div>
          </div>
